...
Os resultados obtidos com a utilização do Mapa de Kohonen superaram em muito qualquer expectativa, dado a facilidade de sua implemntação e o fato de realizar aprendizado não supervisionado. O Mapa de Kohonen mostrou melhor desempenho, ao menos para o fragmento do sinal testado. Nas poucas partes em que o sinal apresentou muito ruído, a rede multicamadas foi mais eficiente.
