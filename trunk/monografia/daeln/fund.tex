...
Esta seção vamos nos concentrar em formas de avaliar o desempenho de sistemas classificadores por meio das seções: Tabela de Contingência \ref{subsec:TabelaCont}, Sensibilidade e Especificidade \ref{subsec:SeEsP}, Curva ROC \ref{subsec:ROCCurva} e Outros Índices Estatísticos \ref{subsec:outros}.
