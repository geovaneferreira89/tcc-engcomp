...
\begin{itemize}
	\item Função de limiar ou threshold:
	\item Função Piecewise-contínua:
	\item Função Sigmoid:
\end{itemize}
...
Além destas duas divisões, o conjunto de dados de treinamento pode ser dividido em dados para estimativa e dados para validação \cite{HAYKIN2011}. Contudo, o estudo aprofundado deste tema foge ao escopo do projeto.
