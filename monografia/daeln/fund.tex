...
na figura ~\ref{fig:RN1}.

\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.7\textwidth]{./figs/RN1.png} 
		\caption[Funcionamento do cérebro humano]{Funcionamento do cérebro humano}
	\fonte{\cite{HAYKIN2011}}
	\label{fig:RN1}
\end{figure}

na figura ~\ref{fig:RN2}.
...
na figura ~\ref{fig:RN4}.

\begin{figure}[!htb]
	\centering
	\includegraphics[width=1\textwidth]{./figs/RN4.png} 
