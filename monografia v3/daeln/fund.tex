...
\begin{figure}[!htb]
	...
	\includegraphics[width=0.5\textwidth]{./figs/limiares.png} 
		\caption[Gráficos de funções de ativação]{Gráficos de funções de ativação}
	\fonte{\cite{HAYKIN2011}}
	\label{fig:limiares}
\end{figure}
...
É possível, portanto, treinar a rede em excesso, se o treinamento não for interrompido no instante certo. Para identificar este instante, a cada período de treinamento, a rede é testada e o erro médio quadrado monitorado. A este procedimento dá-se o nome de método de treinamento de parada antecipada. O menor erro médio indica qual a melhor época de treinamento, com base nos testes \cite{HAYKIN2011}.
