...
O cérebro humano funciona de modo completamente diferente dos computadores digitais convencionais. No entanto, pode ser considerado um computador extremamente complexo, não linear que apresenta paralelismo. As unidades básicas que constituem o cérebro, chamadas neurônios, têm a capacidade de organização de modo a desempenhar tarefas tais como reconhecimento de padrões, percepção e controle motor \cite{HAYKIN2011}.
