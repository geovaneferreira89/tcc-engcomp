...
O capítulo de Fundamentação Teórica forneceu esclarecimento acerca de diversos conhecimentos necessários durante a implementação do projeto. Entre eles, cabe destacar os conceitos abordados pelas seções \ref{sec:Correl} Função Correlação, \ref{sec:RNA} Redes Neurais Artificiais e \ref{sec:AvaliaSis} Avaliação de Sistemas Classificadores. O entendimento destes conceitos em particular é essencial para uma leitura proveitosa dos próximos capítulos desta monografia.
