...
\begin{table}[!htb]
	...
	\textbf{FormPrincipal}       	& Janela principal do sistema, onde é exibido o sinal e realizada as marcações\\ \hline
	\textbf{FormResultados}  		& Janela onde é mostrado canal por canal e a saída da correlação\\ \hline
...
\subsection{Metodologia da Classificação de Padrões}
\label{subsec:met2} 
