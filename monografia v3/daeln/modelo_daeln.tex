...
\begin{table}[!htb]
	...
	\label{tab:rawECG}
			...
			\textit{Threshold} & VP & VN & FP & FN & Sensibilidade & Especificidade & Eficiência & DER \\ \hline
		    \hline
		    1         & 1143 & 1095 & 86 & 39  & 0,967005076 & 0,927180356 & 0,947101143 & 0,0486\\ 
		    0,9       & 1143 & 1093 & 88 & 39  & 0,967005076 & 0,925486876 & 0,946254761 & 0,0493\\ 
		    0,8       & 1144 & 1089 & 92 & 38  & 0,9678511   & 0,922099915 & 0,944985188 & 0,0505\\ 
		    0,7       & 1144 & 1089 & 92 & 38  & 0,9678511   & 0,922099915 & 0,944985188 & 0,0505\\ 
		    0,6       & 1144 & 1084 & 97 & 38  & 0,9678511   & 0,922099915 & 0,942869234 & 0,0524\\ 
		    0,5       & 1144 & 1084 & 97 & 38  & 0,9678511   & 0,922099915 & 0,942869234 & 0,0524\\ 
		    0,4       & 1145 & 1083 & 98 & 37  & 0,968697124 & 0,917019475 & 0,942869234 & 0,0524\\ 
		    0,3       & 1145 & 1082 & 99 & 37  & 0,968697124 & 0,916172735 & 0,942446043 & 0,0528\\ 
		    0,2       & 1145 & 1081 & 100 & 37 & 0,968697124 & 0,915325995 & 0,942022852 & 0,0532\\ 
		    0,1       & 1145 & 1081 & 100 & 37 & 0,968697124 & 0,915325995 & 0,942022852 & 0,0532\\ \hline
		    \end{tabular}
		    \fonte{Autoria Própria}
\end{table}
...
Este capítulo apresenta as seções \ref{RecHardware} Recursos de Hardware, \ref{RecSoftware} Recursos de Software, \ref{Riscos} Análise de Riscos, \ref{Cronograma} Cronogramas e \ref{Horas} Horas de Trabalho.
...
\begin{table}[!htb]
	...
	\label{tab:riscos}
		    ...
		    Falha de comunicação e integração  			& médio/alto (4) & média (3)	   & Não  \\ \hline
		    ...
		    Análise do sistema realizada de modo 		& médio/alto (4) & média/baixa (2) & Não  \\ \hline
		    inadequado									&	   			 &	  			   &      \\ \hline
...
Os objetivos inicialmente definidos foram alcançados plenamente. O projeto concluiu o desenvolvimento de um sistema computacional, capaz visualizar sinais de ECG armazenados em arquivos digitais, apresentando ainda as funcionalidades de marcar e salvar eventos do sinal, e reconhecer padrões.  Além disso, foi implementada uma técnica a mais do que inicialmente planejado. Ao todo, o sistema apresenta três técnicas diferentes para o reconhecimento de padrões: mapa de Kohonen, rede multicamadas treinada com eventos marcados diretamente no sinal e rede multicamadas treinada com eventos obtidos após a extração de características por meio da correlação.

Cada uma das técnicas de reconhecimento de padrões implementada foi testada com o mesmo arquivo de sinal. A rede neural mapa de Kohonen apresentou os valores 0,995769882, 0,99915326 e 0,997460855 para sensibilidade, especificidade e eficiência.

A rede neural Perceptron multicamadas foi testada com o \textit{threshold} (limiar de decisão) variando de 0,1 a 1, e os valores máximos alcançados para sensibilidade, especificidade e eficiência foram 0,995769882, 1 e 0,9970. Os valores mínimos de sensibilidade, especificidade e eficiência foram 0,990693739, 0,99830652 e 0,9953. Nos testes com a rede Perceptron multicamadas com extração de características, a sensibilidade variou de 0,967005076 (valor mínimo) a 0,968697124 (valor máximo). A especificidade variou de 0,915325995 a 0,927180356, e a eficiência de 0,942022852 a 0,947101143.

Todas as técnicas apresentaram valores acima de 0,91 para os índices estatísticos de eficiência, especificidade e sensibilidade. Os valores mínimos da sensibilidade e da especificidade, considerando todas as técnicas, foram 0,967005076 (rede multicamadas treinada com extração de características e \textit{threshold} 0,1) e 0,915325995 (rede multicamadas treinada com extração de características e \textit{threshold} 0,1), respectivamente. A eficiência apresentou o valor mínimo 0,942022852 (rede multicamadas treinada com extração de características e \textit{threshold} 0,1).
...
O desenvolvimento deste trabalho dispendeu 655 horas, que foram dedicadas tanto ao estudo da fundamentação teórica, quanto ao desenvolvimento do projeto propriamente dito. A principal dificuldade encontrada foi devido à necessidade de modificação do escopo do projeto. Em virtude do prazo para a conclusão do sistema, a equipe e o professor orientador decidiram trocar a base de sinais eletroencefalográficos a ser utilizada inicialmente por uma base de sinais eletrocardiográficos, pelo fato de ser pública e possuir marcações dos eventos que se pretendia detectar.
